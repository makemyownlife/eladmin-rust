      ...
      <el-col :xs="24" :sm="24" :md="14" :lg="13" :xl="13">
        <el-card class="box-card">
          <div slot="header" class="clearfix">
            <span>字典详情</span>
            <el-button
              v-if="checkPer(['admin','dict:add']) && this.$refs.dictDetail && this.$refs.dictDetail.query.dict_name"
              class="filter-item"
              size="mini"
...
export default {
  ...
  cruds() {
    return [
      CRUD({ title: '字典', url: 'api/v1/dict/paged', idField: 'dict_id', crudMethod: { ...crudDict }})
    ]
  },
  ...
  methods: {
    ...
    handleCurrentChange(val) {
      if (val) {
        this.$refs.dictDetail.query.dict_name = val.name
        this.$refs.dictDetail.dictId = val.dict_id
