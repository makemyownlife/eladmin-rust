      ...
      <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU" :visible="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="排序" prop="dict_sort">
            <el-input-number v-model.number="form.dict_sort" :min="0" :max="999" controls-position="right" style="width: 370px;" />
          </el-form-item>
        </el-form>
...
const defaultForm = { id: null, label: null, value: null, dict_sort: 999 }

export default {
  components: { pagination, rrOperation, udOperation },
  cruds() {
    return [
      CRUD({ title: '字典详情', url: 'api/v1/dictdetail/paged', query: { dict_name: '' }, idField: 'detail_id', sort: ['dictSort,asc', 'id,desc'],
  ...
  mixins: [
    ...
    header(),
    form(function() {
      return Object.assign({ dict_id: this.dictId, ...defaultForm })
    })],
  data() {
    return {
      dictId: null,
