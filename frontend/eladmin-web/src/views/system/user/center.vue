        ...
        <el-card class="box-card">
          ...
          <div>
            <div style="text-align: center">
              <div class="el-upload">
                <img :src="user.avatar_name ? baseApi + '/api/v1/avatar/' + user.avatar_name : Avatar" title="点击上传头像" class="avatar" @click="toggleShow">
                <myUpload
                  v-model="show"
                  :headers="headers"
                  :url="updateAvatarApi"
            ...
            <ul class="user-info">
              ...
              <li><svg-icon icon-class="user1" /> 用户昵称 <div class="user-right">{{ user.nick_name }}</div></li>
            ...
            <el-tab-pane label="用户资料" name="first">
              <el-form ref="form" :model="form" :rules="rules" style="margin-top: 10px;" size="small" label-width="65px">
                <el-form-item label="昵称" prop="nick_name">
                  <el-input v-model="form.nick_name" style="width: 35%" />
...
export default {
  ...
  created() {
    this.form = { id: this.user.id, nick_name: this.user.nick_name, gender: this.user.gender, phone: this.user.phone }
